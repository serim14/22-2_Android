...
public class ProfessorActivity extends AppCompatActivity {
    ...
    String [] professors = {"음두헌","이형규", "이재호", "강지헌", "왕수현"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, professors);   // cell 배열
        ...
        professorList.setOnItemClickListener(new AdapterView.OnItemClickListener() {    // cell 중 하나 클릭
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("professor", professors[i]);    // 어느 셀이 선택됐는가를 넘겨야함, 정수값, (교수이름)
